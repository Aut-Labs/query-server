...
function holeTwo(ctx, hole, zoneHeight) {
  ctx.drawImage(hole, (hole.height / 2) * -1 - zoneHeight, (hole.height / 2) * -1);
}
function holeFive(ctx, hole, zoneHeight) {
  ctx.drawImage(hole, (hole.height / 2) * -1 + zoneHeight, (hole.height / 2) * -1);
}
function holeFour(ctx, hole, zoneHeight) {
  ctx.drawImage(hole, (hole.height / 2) * -1, (hole.height / 2) * -1 - zoneHeight);
}
function holeThree(ctx, hole, zoneHeight) {
  ctx.drawImage(hole, (hole.height / 2) * -1, (hole.height / 2) * -1 + zoneHeight);
}
function holeOne(ctx, hole, zoneHeight) {
  ctx.drawImage(hole, (hole.height / 2) * -1 - zoneHeight, (hole.height / 2) * -1 - zoneHeight);
}
