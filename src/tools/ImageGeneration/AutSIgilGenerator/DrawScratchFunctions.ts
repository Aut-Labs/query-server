...
function OneThree(ctx, mark, triplediagonalOffestX, triplediagonalOffestY) {
  ...
  ctx.drawImage(mark, (mark.height / 2) * -1 - triplediagonalOffestX, -218 + triplediagonalOffestY);
  ctx.rotate((-63 * Math.PI) / 180);
}
...
function OneNine(ctx, mark, doubleDiagonalOffsetX) {
  ...
  ctx.drawImage(mark, (mark.height / 2) * -1 - doubleDiagonalOffsetX, (mark.height / 2) * -1 + 23);
  ctx.rotate((-45 * Math.PI) / 180);
}
...
function TwoThree(ctx, mark, zoneDiagonal) {
  ctx.rotate((45 * Math.PI) / 180);
  ctx.drawImage(mark, (mark.height / 2) * -1, (mark.height / 2) * -1 + 23 + zoneDiagonal / 2);
  ctx.rotate((-45 * Math.PI) / 180);
}
...
function FourNine(ctx, mark, doubleMarkOffset) {
  ctx.rotate((90 * Math.PI) / 180);
  ctx.drawImage(mark, (mark.height / 2) * -1 - doubleMarkOffset, (mark.height / 2) * -1 + 23);
  ctx.rotate((-90 * Math.PI) / 180);
}
...
function TwoEight(ctx, mark, zoneHeight, doubleMarkOffset) {
  ctx.rotate((90 * Math.PI) / 180);
  ctx.drawImage(mark, (mark.height / 2) * -1 + doubleMarkOffset, (mark.height / 2) * -1 + 23 + zoneHeight);
  ctx.rotate((-90 * Math.PI) / 180);
}
